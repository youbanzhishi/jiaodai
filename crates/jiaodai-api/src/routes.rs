...
//! - Phase 9: OpenLink (identity card/short link)
//! - Phase 10: OpenVault (vault ref/key shares)
//! - Phase 11: CORS + auth docs for frontend
    ...
    Json(json!({
        ...
        "capabilities": {
            ...
            "will_create": {
                ...
                "parameters": ["creator_id", "heartbeat_interval_days", "viewers"]
            },
            "capsule_create": {
        ...
        "endpoints": {
            ...
            "certificate": "GET /api/v1/tape/{id}/certificate",
            "share": "POST /api/v1/tape/{id}/share",
        ...
        "openmind_integration": {
            "description": "Placeholder for OpenMind knowledge retrieval integration",
            "status": "pending"
        }
    }))
}
